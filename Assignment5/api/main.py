...
#below this is everything for sandwiches.py
...
#everything below this is resources.py
...
#below this is everything for recipes.py
...
#below this is everything for order_details.py
@app.post("/orders_details/", response_model=schemas.OrderDetail, tags=["Order Details"])
...
@app.get("/order_detail/", response_model=list[schemas.OrderDetail], tags=["Order Details"])
...
@app.put("/order_details/{order_detail_id}", response_model=schemas.OrderDetail, tags=["Orders Details"])
...
@app.delete("/order_details/{order_detail_id}", tags=["Orders Details"])
